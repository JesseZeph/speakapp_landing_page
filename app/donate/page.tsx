...
const Donate = () => {
    const content = [
        ...
        "Let&apos;s protect our future by safeguarding our minds.<br />Let&apos;s promote sanity.<br />Let&apos;s create a safe space in a toxic world.<br />Let&apos;s support mental wellness in our society.",
        "We may lose our society if we don&apos;t fight for a sane atmosphere.<br />Join us. Give hope. Let them SPEAK."
    ];
