            ...
            <FeatureTile
                images={[
                    ...
                    },
                    {
                        ...
                        className: 'w-[180px] h-[300px] md:w-[300px] md:h-[300px] mt-15 md:hidden lg:block lg:w-[300px] lg:h-[550px]'
                    }
                ]}
            />
            ...
            <FeatureTileReverse
                images={[
                    ...
                    },
                    {
                        ...
                        className: 'w-[100px] h-[190px] mt-20 md:hidden lg:block lg:w-[250px] lg:h-[480px]'
                    },
                    {
                        src: communityThree.src,
                        alt: 'community members',
                        className: 'w-[100px] h-[190px] md:hidden mt-5 lg:block lg:w-[250px] lg:h-[480px]'
                    }
                ]}
            ...
            <FeatureTile
                images={[
                    ...
                    },
                    {
                        src: signUpTwo.src,
                        alt: 'appointment details',
                        className: 'w-[200px] h-[280px] md:w-[300px] md:h-[300px] mt-15 md:hidden lg:block lg:w-[385px] lg:h-[530px]'
                    }
                ]}
            ...
            <FeatureTileReverse
                images={[
                    ...
                    },
                    {
                        src: earnTwo.src,
                        alt: 'earn',
                        className: 'w-[110px] h-[200px] md:hidden lg:block lg:w-[250px] lg:h-[480px]'
                    },
                    {
                        src: earnThree.src,
                        alt: 'earn',
