...
import { privacyContentSections, privacySections } from '@/data'
...
const Privacy = () => {
    ...
    useEffect(() => {
        ...
        privacyContentSections.forEach((section: Section) => {
        ...
        <section className='w-full min-h-screen flex flex-col overflow-x-hidden'>
            <ScrollReveal>
                <div className='container mx-auto px-5 pt-5 pb-10'>
                    <h1 className='text-base md:text-3xl text-center mb-10 font-semibold'>Privacy Policy</h1>
                    <div className='flex flex-row gap-10'>
                        ...
                        <div className='w-full'>
                            {privacyContentSections.map((section: Section) => (
                                <div
                                    key={section.id}
                                    id={section.id}
